...
public class Exercise6 {
    public static void main(String[] args) {
        var list = new ArrayList<MyTriangle>();
        File filenames = new File("/Users/kuogongzi/IdeaProjects/wgk20202091105/src/wgk20202091105lab6/triangles.txt");
        try(InputStreamReader reader = new InputStreamReader(new FileInputStream(filenames))) {
            ...
            list.sort((MyTriangle o1, MyTriangle o2) -> {
